...
int main()
{
	...
	for (double t = 0.01;t < PI * 2;t += 0.01)
	{
		xx = 2 * 0.001700*cos(t) + 0.001700*cos(2 * t);
		yy = 2 * 0.001700*sin(t) - 0.001700*sin(2 * t);

		ofile1 << "		<Placemark><name>t=" << t << "</name><styleUrl>#z1</styleUrl><Point><coordinates>" << setiosflags(ios::fixed) << setprecision(6) << xx - 118.2913436 << ',' << yy+ 34.0212453 << "</coordinates></Point></Placemark>" << endl;
